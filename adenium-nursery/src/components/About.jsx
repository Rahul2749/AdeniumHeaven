      ...
      <div className="about-container">
        ...
        <div className="about-right" style={{ opacity: 0 }}>
          ...
          <p className="about-body">
            Nestled in the heart of Tumsar, our Adenium nursery in India is devoted to cultivating extraordinary Desert Rose plants. We believe each plant carries a unique story — from the arid deserts of Arabia to your living room window.
          </p>
          <p className="about-body">
            When you buy Adenium online with us, every plant arrives in hand-selected ceramic vessels with personalised care guidance and the promise of decades of bloom. We don't just sell plants — we begin relationships between growers and their living art.
          </p>
